...
import SlideCarousel from '../design1.0/SlideCarousel/SlideCarousel';
import SlideCarouselDots from '../design1.0/SlideCarousel/SlideCarouselDots';

console.log(SlideCarousel, SlideCarouselDots);